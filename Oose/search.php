...
<div class="card mt-5" style="font-style:italic;">  
...
<?php
     ...
     ?>
     <div class=" card container" style="margin-top:40px;height:340px; width:600px;background-color:whitesmoke;">
         <h2 class="text-center" style="margin-top:80px;">Sorry we couldn't find any matches item</h2>
         <p class="text-muted text-center">Please try to search correct item</p><br>
         <a  class="btn btn-success text-center mb-3"
            style="  height:45px; border-radius:10px; font-style: italic;
    margin-left:220px;width:130px;" href="userproduct.php">Product list</a>
 </div>
     <?php
     }
    }
